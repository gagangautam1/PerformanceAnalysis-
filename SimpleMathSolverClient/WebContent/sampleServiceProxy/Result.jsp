...
<jsp:useBean id="sampleServiceProxyid" scope="session" class="Services.ServiceProxy" />
<%
...
case 10:
        gotMethod = true;
        Services.Service getService10mtemp = sampleServiceProxyid.getService();
...
case 13:
        gotMethod = true;
        sampleServiceProxyid.find_prime();
break;
case 16:
        gotMethod = true;
        sampleServiceProxyid.check_prime();
break;
}
} catch (Exception e) { 
%>
